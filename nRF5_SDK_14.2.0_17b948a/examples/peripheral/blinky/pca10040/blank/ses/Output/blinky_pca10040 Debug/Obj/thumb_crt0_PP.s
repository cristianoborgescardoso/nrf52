# 1 "D:/windows_app/SEGGER/source/thumb_crt0.s"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/windows_app/SEGGER/source/thumb_crt0.s"
# 59 "D:/windows_app/SEGGER/source/thumb_crt0.s"
  .syntax unified
...
1:
  ...
  bl memory_copy
# 170 "D:/windows_app/SEGGER/source/thumb_crt0.s"
  ...
  movs r2, #0
  bl memory_set
# 192 "D:/windows_app/SEGGER/source/thumb_crt0.s"
...
ctor_end:
  ...
  .type start, function
start:
# 237 "D:/windows_app/SEGGER/source/thumb_crt0.s"
  movs r0, #0
  movs r1, #0
  ...
  .thumb_func
exit:
# 273 "D:/windows_app/SEGGER/source/thumb_crt0.s"
exit_loop:
  b exit_loop
...
1:
  ...
  .word 0x0
# 417 "D:/windows_app/SEGGER/source/thumb_crt0.s"
